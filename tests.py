...
class UserModelCase(unittest.TestCase):
    ...
    def test_user_courses(self):
        ...
        # check the enrolled course name of each user
        e1 = u1.enrolled_coursename()
        e2 = u2.enrolled_coursename()
        e3 = u3.enrolled_coursename()
        e4 = u4.enrolled_coursename()

        self.assertEqual(e1, ['course1', 'course2'])
        self.assertEqual(e2, ['course2', 'course3'])
        self.assertEqual(e3, ['course3', 'course4', 'course1', 'course2'])
        self.assertEqual(e4, [])
    ...
    def test_user_quizes(self):
        ...
        cq1 = u1.completed_quizdata()
        cq2 = u2.completed_quizdata()
        cq3 = u3.completed_quizdata()
        cq4 = u4.completed_quizdata()

        self.assertEqual(cq1, [('quiz2', 60), ('quiz1', 80)])
        self.assertEqual(cq2, [('quiz1', 85), ('quiz2', 70)])
